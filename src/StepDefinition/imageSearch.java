...
public class imageSearch extends baseClass{
	...
	public void the_user_searches_for_keyword_Instabug() throws Throwable {
		try {
			WebElement searchBar = driver.findElement(By.xpath("//body[1]/div[2]/div[2]/div[2]/form[1]/div[1]/div[1]/div[1]/div[1]/div[2]/input[1]"));
			searchBar.sendKeys("Instabug");
	...
	@Then("^All results should be relevant to Instabug from \"([^\"]*)\"$")
	public void all_results_should_be_relevant_to_Instabug_from(String fromScreen) throws Throwable {
		List<WebElement> imagesSearchResults = driver.findElements(By.xpath("//a[@class='VFACy kGQAp sMi44c lNHeqe WGvvNb']"));
		assertTrue(isImagesRelevant(imagesSearchResults, "Instabug"), "The images search results are not relevant");
	...
	public void the_user_searchs_with_Instabug_as_a_keyword() throws Throwable {
	...
	public void the_user_filter_the_data_with_the_images_tab() throws Throwable {
		...
		try {
			WebElement navBar = driver.findElement(By.xpath("//body[1]/div[7]/div[1]/div[4]/div[1]"));
