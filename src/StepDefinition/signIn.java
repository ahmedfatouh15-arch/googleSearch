...
public class signIn extends baseClass{
	...
	@Then("^the user should sign in and navigate back to search screen$")
	public void the_user_should_sign_in_and_navigate_back_to_search_screen() throws Throwable {
